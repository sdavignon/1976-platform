...
Priority contributions: schema/data migration tools preserving IDs; scalable SQL-scoped policies; realtime subscriptions; identity-provider adapters; shared-email port; Worker/Hyperdrive runtime; typed entity registries; provider contract tests.
